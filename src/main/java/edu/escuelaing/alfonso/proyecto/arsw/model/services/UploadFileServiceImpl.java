...
public class UploadFileServiceImpl implements UploadFileService {
	...
	public boolean eliminar(String nombreFoto) {
		if(nombreFoto != null && nombreFoto.length() > 0) {
			Path rutaFotoAnterior = Paths.get("uploads").resolve(nombreFoto).toAbsolutePath();//ruta anterior
			File archivoFotoAnterior = rutaFotoAnterior.toFile();//lo convertimos a archivo
